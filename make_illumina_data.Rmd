...
illumina.class <- illumina.class/colSums(illumina.class)
...
illumina.order <- illumina.order/colSums(illumina.order)
...
illumina.family <- illumina.family/colSums(illumina.family)
...
illumina.genus <- illumina.genus/colSums(illumina.genus)
...
illumina.species <- illumina.species/colSums(illumina.species)
